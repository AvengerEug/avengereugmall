<template>
  <div class="mod-home">
    <h3>项目介绍</h3>
    <ul>
      <li>基于<strong>SpringCloud + Nacos + Mybatis Plus + renren代码生成器 + renren-fast-vue + renren-fast + MySQL + Redis缓存+ RabbitMQ消息队列 + ES搜索引擎 + ELK + OSS搭建企业级B2C</strong>电商项目。
          <br>后台管理前端功能，提供一套更优的前端解决方案</li>
