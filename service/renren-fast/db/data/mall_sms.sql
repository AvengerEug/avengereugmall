...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品会员价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (1, 3, 2, '白银会员', 4600.0000, NULL);
...
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (1, 1, 2.0000, 500.0000, 0);
INSERT INTO `sms_sku_full_reduction` VALUES (2, 5, 2.0000, 500.0000, 1);
INSERT INTO `sms_sku_full_reduction` VALUES (3, 9, 1.0000, 300.0000, 1);
INSERT INTO `sms_sku_full_reduction` VALUES (4, 10, 1.0000, 300.0000, 0);
...
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (1, 1, 2, 0.95, 4084.0500, 1);
INSERT INTO `sms_sku_ladder` VALUES (2, 5, 2, 0.80, 3439.2000, 1);
INSERT INTO `sms_sku_ladder` VALUES (3, 9, 1, 0.95, 4084.0500, 0);
INSERT INTO `sms_sku_ladder` VALUES (4, 10, 1, 0.95, 4558.1000, 1);
