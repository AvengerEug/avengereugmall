...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (2, '入网型号', 0, 'sss', 'A2108', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (3, '品牌', 0, 'ssss', 'Apple', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (4, '机身长度（mm）', 0, 'sss', '150.9', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (5, '机身材质工艺', 0, 'sss', '玻璃搭配铝金属设计', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (6, 'CPU品牌', 0, 'saasd', '以官网信息为准', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (7, '拍照特点', 0, 'dfsfds', 'HDR;光学防抖', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (8, '选择颜色', 0, '撒地方', '白色;红色;黑色', 0, 1, 225, 0, 1);
INSERT INTO `pms_attr` VALUES (9, '选择版本', 0, 'SSS', '64GB;128GB;256GB', 0, 1, 225, 0, 1);
INSERT INTO `pms_attr` VALUES (10, '购买方式', 0, '撒地方', '官方标配;保值换新版', 0, 1, 225, 0, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1, 2, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (2, 3, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (3, 4, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (4, 5, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (5, 6, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (6, 7, 5, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性分组' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (1, '主体', 1, '主体', '1111', 225);
INSERT INTO `pms_attr_group` VALUES (2, '基本信息', 2, '基本信息', 'sss', 225);
INSERT INTO `pms_attr_group` VALUES (3, '主芯片', 3, '主芯片', '1sf', 225);
INSERT INTO `pms_attr_group` VALUES (4, '屏幕', 4, '屏幕', 'sss', 225);
INSERT INTO `pms_attr_group` VALUES (5, '后置摄像头', 5, '后置摄像头', 'sdaf', 225);
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (2, '华为', 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-27/cfadf77b-6daa-4919-8c8c-8b0590d640b7_huawei.png', '华为', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (3, '小米', 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-27/b9849f87-6af5-4eb3-8e70-851b2e822acc_xiaomi.png', '小米', 1, 'M', 1);
INSERT INTO `pms_brand` VALUES (4, 'oppo', 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-27/ef29d615-263e-4373-8dd9-049e7658c073_oppo.png', 'oppo', 1, 'O', 1);
INSERT INTO `pms_brand` VALUES (5, 'Apple', 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-27/16c3e70f-93a7-471b-8f44-1ec9e90d68a7_apple.png', '苹果', 1, 'A', 1);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (1, 2, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (2, 5, 225, 'Apple', '手机');
...
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (1, 1, 2, '入网型号', 'A2108', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (2, 1, 3, '品牌', 'Apple', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (3, 1, 4, '机身长度（mm）', '150.9', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (4, 1, 5, '机身材质工艺', '玻璃搭配铝金属设计', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (5, 1, 6, 'CPU品牌', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (6, 1, 4, '机身长度（mm）', 'HDR;光学防抖', NULL, 1);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (1, 1, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//fe792305-27bf-4fc5-8d07-4cb5041732b0_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (2, 1, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//ab16fdac-5dca-4587-8f39-f10b1c68e5b7_ccd1077b985c7150.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (3, 2, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//fe792305-27bf-4fc5-8d07-4cb5041732b0_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (4, 2, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//ab16fdac-5dca-4587-8f39-f10b1c68e5b7_ccd1077b985c7150.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (5, 3, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//fe792305-27bf-4fc5-8d07-4cb5041732b0_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (6, 3, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//ab16fdac-5dca-4587-8f39-f10b1c68e5b7_ccd1077b985c7150.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (7, 4, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//fe792305-27bf-4fc5-8d07-4cb5041732b0_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (8, 4, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//ab16fdac-5dca-4587-8f39-f10b1c68e5b7_ccd1077b985c7150.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (9, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//cbaf5070-88e3-449c-89e3-5aa7fcfc9999_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (10, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//9e38dd11-59b6-4c59-838d-fd73e940a5aa_749d8efdff062fb0.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (11, 6, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//cbaf5070-88e3-449c-89e3-5aa7fcfc9999_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (12, 6, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//9e38dd11-59b6-4c59-838d-fd73e940a5aa_749d8efdff062fb0.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (13, 7, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//cbaf5070-88e3-449c-89e3-5aa7fcfc9999_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (14, 7, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//9e38dd11-59b6-4c59-838d-fd73e940a5aa_749d8efdff062fb0.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (15, 8, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//cbaf5070-88e3-449c-89e3-5aa7fcfc9999_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (16, 8, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//9e38dd11-59b6-4c59-838d-fd73e940a5aa_749d8efdff062fb0.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (17, 9, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//876e0f56-6616-4dcb-8746-130be4f23e28_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (18, 9, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//febee122-6ed6-4a89-8a5d-b4a4c4007544_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (19, 10, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//876e0f56-6616-4dcb-8746-130be4f23e28_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (20, 10, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//febee122-6ed6-4a89-8a5d-b4a4c4007544_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (21, 11, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//876e0f56-6616-4dcb-8746-130be4f23e28_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (22, 11, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//febee122-6ed6-4a89-8a5d-b4a4c4007544_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (23, 12, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//876e0f56-6616-4dcb-8746-130be4f23e28_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (24, 12, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//febee122-6ed6-4a89-8a5d-b4a4c4007544_a2c208410ae84d1f.jpg', NULL, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (1, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//ab16fdac-5dca-4587-8f39-f10b1c68e5b7_ccd1077b985c7150.jpg', 'iPhone XR移动联通电信4G手机 双卡双待 红色 64GB 官方标配 红色 64GB 官方标配', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 4299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (2, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//ab16fdac-5dca-4587-8f39-f10b1c68e5b7_ccd1077b985c7150.jpg', 'iPhone XR移动联通电信4G手机 双卡双待 红色 64GB 官方标配 红色 64GB 保值换新版', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 4798.0000, 0);
INSERT INTO `pms_sku_info` VALUES (3, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//ab16fdac-5dca-4587-8f39-f10b1c68e5b7_ccd1077b985c7150.jpg', 'iPhone XR移动联通电信4G手机 双卡双待 红色 64GB 官方标配 红色 128GB 官方标配', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 4699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (4, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//ab16fdac-5dca-4587-8f39-f10b1c68e5b7_ccd1077b985c7150.jpg', 'iPhone XR移动联通电信4G手机 双卡双待 红色 64GB 官方标配 红色 128GB 保值换新版', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 5299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (5, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//9e38dd11-59b6-4c59-838d-fd73e940a5aa_749d8efdff062fb0.jpg', 'iPhone XR 移动联通电信4G手机 双卡双待 红色 64GB 官方标配白色 64GB 官方标配', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 4299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (6, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//9e38dd11-59b6-4c59-838d-fd73e940a5aa_749d8efdff062fb0.jpg', 'iPhone XR移动联通电信4G手机 双卡双待 红色 64GB 官方标配 白色 64GB 保值换新版', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 4798.0000, 0);
INSERT INTO `pms_sku_info` VALUES (7, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//9e38dd11-59b6-4c59-838d-fd73e940a5aa_749d8efdff062fb0.jpg', 'iPhone XR 移动联通电信4G手机 双卡双待 红色 64GB 官方标配白色 128GB 官方标配', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 4699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (8, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//9e38dd11-59b6-4c59-838d-fd73e940a5aa_749d8efdff062fb0.jpg', 'iPhone XR 移动联通电信4G手机 双卡双待 红色 64GB 官方标配白色 128GB 保值换新版', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 5299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (9, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//febee122-6ed6-4a89-8a5d-b4a4c4007544_a2c208410ae84d1f.jpg', 'iPhone XR 移动联通电信4G手机 双卡双待 红色 64GB 官方标配黑色 64GB 官方标配', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 4299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (10, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//febee122-6ed6-4a89-8a5d-b4a4c4007544_a2c208410ae84d1f.jpg', 'iPhone XR 移动联通电信4G手机 双卡双待 红色 64GB 官方标配黑色 64GB 保值换新版', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 4798.0000, 0);
INSERT INTO `pms_sku_info` VALUES (11, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//febee122-6ed6-4a89-8a5d-b4a4c4007544_a2c208410ae84d1f.jpg', 'iPhone XR 移动联通电信4G手机 双卡双待 红色 64GB 官方标配黑色 128GB 官方标配', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 4699.0000, 0);
INSERT INTO `pms_sku_info` VALUES (12, 1, 'iPhone XR', NULL, 225, 5, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//febee122-6ed6-4a89-8a5d-b4a4c4007544_a2c208410ae84d1f.jpg', 'iPhone XR移动联通电信4G手机 双卡双待 红色 64GB 官方标配 黑色 128GB 保值换新版', 'iPhoneXR领券立减350元，Apple产品，酷玩一夏，iPhone11ProMax至高优惠2000元！更多优惠！', 5299.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (1, 1, 8, '选择颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 1, 9, '选择版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (3, 1, 10, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (4, 2, 8, '选择颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (5, 2, 9, '选择版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (6, 2, 10, '购买方式', '保值换新版', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (7, 3, 8, '选择颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (8, 3, 9, '选择版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (9, 3, 10, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (10, 4, 8, '选择颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (11, 4, 9, '选择版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (12, 4, 10, '购买方式', '保值换新版', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (13, 5, 8, '选择颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (14, 5, 9, '选择版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (15, 5, 10, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (16, 6, 8, '选择颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (17, 6, 9, '选择版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (18, 6, 10, '购买方式', '保值换新版', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (19, 7, 8, '选择颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (20, 7, 9, '选择版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (21, 7, 10, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (22, 8, 8, '选择颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (23, 8, 9, '选择版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (24, 8, 10, '购买方式', '保值换新版', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (25, 9, 8, '选择颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (26, 9, 9, '选择版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (27, 9, 10, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (28, 10, 8, '选择颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (29, 10, 9, '选择版本', '64GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (30, 10, 10, '购买方式', '保值换新版', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (31, 11, 8, '选择颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (32, 11, 9, '选择版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (33, 11, 10, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (34, 12, 8, '选择颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (35, 12, 9, '选择版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (36, 12, 10, '购买方式', '保值换新版', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (1, 1, NULL, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//dccb73b1-f2b1-4b1b-88b7-60c5870ffefc_7ae0120ec27dc3a7.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (2, 1, NULL, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//fe792305-27bf-4fc5-8d07-4cb5041732b0_5b5e74d0978360a1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (3, 1, NULL, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//ab16fdac-5dca-4587-8f39-f10b1c68e5b7_ccd1077b985c7150.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (4, 1, NULL, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//cbaf5070-88e3-449c-89e3-5aa7fcfc9999_23cd65077f12f7f5.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (5, 1, NULL, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//9e38dd11-59b6-4c59-838d-fd73e940a5aa_749d8efdff062fb0.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (6, 1, NULL, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//876e0f56-6616-4dcb-8746-130be4f23e28_b8494bf281991f94.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (7, 1, NULL, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//febee122-6ed6-4a89-8a5d-b4a4c4007544_a2c208410ae84d1f.jpg', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (1, 'iPhone XR', 'Apple iPhone XR', 225, 5, 0.4600, 0, '2020-07-31 23:49:11', '2020-07-31 23:49:11');
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (1, 'https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//abc30e0d-9893-4ac5-8039-15a111e1455f_f205d9c99a2b4b01.jpg,https://avenger-mall.oss-cn-hangzhou.aliyuncs.com/2020-07-31//d54835a4-1e73-435b-87f7-b2cf80e0a45e_apple.png');
